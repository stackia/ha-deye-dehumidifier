...
from custom_components.deye_dehumidifier.humidifier import DeyeDehumidifier
from homeassistant.components.humidifier import MODE_NORMAL, HumidifierAction
...
async def test_humidifier_state_from_fake_device(
    ...
    assert entity.target_humidity_step == 5.0
    assert entity.mode == MODE_NORMAL
